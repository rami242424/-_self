// isNaN은 데이터를 숫자로 변환했을 때 NaN인지 아닌지 확인하기 위해 사용하는 메소드
...
// !isNaN(value[0]) : 숫자를 걸러내는 방법!! (암기!!)

// 문제 let value = "p2o4i8gj2" 일떄 숫자만 걸러내라
...
/* 
Type(x)가 NaN이면 false를 반환합니다. y가 NaN이면 false를 반환합니다. 이것은 알고리즘이 먼저 피연산자 중 하나가 NaN유형을 확인하기 전에 있는지 확인하고 그렇다면 false어쨌든 반환할 것임을 의미합니다.
*/
...
// 암기
console.log(NaN == NaN); // false  -> 둘중 하나라도 NaN이면 NaN
console.log(NaN === NaN); // false
console.log("---"); // ---, undefined
