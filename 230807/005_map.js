...
x // x는 수정되지 않습니다! // (4) [1, 2, 3, 4]
y // [3, 6, 9, 12] 새로운 배열이 만들어집니다. // (4) [3, 6, 9, 12]
...
let data = [1, 2, 3, 4]
data.map(v => 'hello' + v)
data // 원본은 수정되지 않습니다! // (4) [1, 2, 3, 4]


// 같은 코드 1(****)
[1, 2, 3, 4].map(v => 'hello' + v) // (4) ['hello1', 'hello2', 'hello3', 'hello4']

// 같은 코드 2
function 함수(v) {
    return 'hello' + v
}
[1, 2, 3, 4].map(함수) // (4) ['hello1', 'hello2', 'hello3', 'hello4']

// 같은 코드 3
[1, 2, 3, 4].map(function (v) {
    return 'hello' + v
}) // (4) ['hello1', 'hello2', 'hello3', 'hello4']
